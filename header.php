...
<header class="<?= is_page_template('templates/page_resume.php') || is_page_template('templates/page_lettre-motivation.php') || is_page_template('templates/page_nina.php') || is_page_template('templates/page_resume_en.php') ? 'd-none' : ''; ?>">
    <div>
        <div class="img-container-circle-icon-lg">
            <a href="<?=home_url();?>" class="logo-gradient" aria-label="<?=get_bloginfo('name');?>" title="Home">
