        ...
        <section>
            ...
            <div class="wrapper wrapper-border-inline resume-intro flex-column-center">
                ...
                <div class="flex-start-desktop">
                    <ul>
                        ...
                        <li><p><span>Status:</span> <span>Freelance Austin and France(W8BEN).</span></p></li>
                    </ul>
                    <ul>
                ...
                <div>
                    <div class="flex-column-start">
                        ...
                        <ul>
                            ...
                            <li><p>Design system principles (atomic design, design tokens).</p></li>
                    ...
                    <div class="flex-column-start">
                        ...
                        <ul>
                            <li><p>15+ custom WordPress themes.</p></li>
                            <li><p>30+ sites maintenance and optimization.</p></li>
            ...
            <h2>Recent projects</h2>
                ...
                <div class="flex-column-start projet">
                    ...
                    <div class="">
                        <div class="card-color"><p>Pixel-perfect integration, migration from Drupal to WordPress.</p></div>
                    </div>
                </div>
                <div class="flex-column-start projet">
