...
<ul class="ul-reset">
    ...
    <?php else: ?>
        <li class="<?= \Theme_base\Base::get_active_class($item) ?> <?= \Theme_base\Base::get_parent_active_class($item, $object) ?>">
            <details name="dropdown-nav-header" aria-label="navigation" tabindex="0" class="dropdown dropdown-nav">
                <summary class="dropdown-link ">
                    ...
                    <span role="button" class="dropdown-title btn nav-link"><?=$item['title']?></span>
                </summary>
